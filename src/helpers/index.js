...
export const urls = {
  showTransaction: tx => `https://cn.etherscan.com/tx/${tx}/`,
  showAddress: address => `https://cn.etherscan.com/address/${address}/`,
  showToken: address => `https://cn.etherscan.com/token/${address}/`,
  showBlock: block => `https://cn.etherscan.com/block/${block}/`
}
