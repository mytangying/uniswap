...
export default [
  ...
  new Token(ChainId.MAINNET, '0x08d967bb0134f2d07f7cfb6e246680c53927dd30', 18, 'MATH', 'MATH Token'),
  new Token(ChainId.MAINNET, '0xed91879919b71bb6905f23af0a68d231ecf87b14', 18, 'DMG', 'DMM: Governance'),
  new Token(ChainId.MAINNET, '0x43044f861ec040db59a7e324c40507addb673142', 18, 'CAP', 'Cap'),
  new Token(ChainId.MAINNET, '0xeeee2a622330e6d2036691e983dee87330588603', 18, 'ASKO', 'Askobar Network'),
  new Token(ChainId.MAINNET, '0xb60fde5d798236fbf1e2697b2a0645380921fccf', 18, 'STONK', 'STONK'),
  new Token(ChainId.MAINNET, '0xa7de087329bfcda5639247f96140f9dabe3deed1', 18, 'STA', 'Statera'),
  new Token(ChainId.MAINNET, '0xf80d589b3dbe130c270a69f1a69d050f268786df', 18, 'DAM', 'Datamine'),
  new Token(ChainId.MAINNET, '0x8a9c67fee641579deba04928c4bc45f66e26343a', 18, 'JRT', 'Jarvis Reward Token'),
  new Token(ChainId.MAINNET, '0x1f8f123bf24849443a56ed9fc42b9265b7f3a39a', 18, 'uTOPIA', 'UniTopia'),
  new Token(ChainId.MAINNET, '0x40fd72257597aa14c7231a7b1aaa29fce868f677', 18, 'XOR', 'Sora Token'),
  new Token(ChainId.MAINNET, '0x26ce25148832c04f3d7f26f32478a9fe55197166', 18, 'DEXT', 'DEXTools'),
  new Token(ChainId.MAINNET, '0x37236cd05b34cc79d3715af2383e96dd7443dcf1', 0, 'SLP', 'Small Love Potion'),
  new Token(ChainId.MAINNET, '0xf29e46887ffae92f1ff87dfe39713875da541373', 18, 'UNC', 'UniCrypt'),
  new Token(ChainId.MAINNET, '0xc0134b5b924c2fca106efb33c45446c466fbe03e', 18, 'ALEPH', 'aleph.im'),
  new Token(ChainId.MAINNET, '0x6b785a0322126826d8226d77e173d75dafb84d11', 18, 'VLT', 'Bankroll Vault'),
  new Token(ChainId.MAINNET, '0x56d811088235F11C8920698a204A5010a788f4b3', 18, 'BZRX', 'bZx Protocol Token'),
  new Token(ChainId.MAINNET, '0x8fB00FDeBb4E83f2C58b3bcD6732AC1B6A7b7221', 8, 'ORN', 'Orion Protocol'),
  new Token(ChainId.MAINNET, '0xcc4304a31d09258b0029ea7fe63d032f52e44efe', 18, 'SWAP', 'TrustSwap Token'),
  new Token(ChainId.MAINNET, '0x66186008c1050627f979d464eabb258860563dbe', 18, 'MDS', 'MediShares Token'),
  new Token(ChainId.MAINNET, '0x9f284e1337a815fe77d2ff4ae46544645b20c5ff', 18, 'KTON', 'Evolution Land Kryptonite'),
  new Token(ChainId.MAINNET, '0x0bc529c00c6401aef6d220be8c6ea1667f6ad93e', 18, 'YFI', 'yearn.finance'),
  new Token(ChainId.MAINNET, '0xf0fac7104aac544e4a7ce1a55adf2b5a25c65bd1', 18, 'PAMP', 'Pamp Network'),
]
